    ...
    <div class="telEdit">
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class=" demo-ruleForm" label-width="120px">
        <el-form-item label="新支付密码"  prop="newPass">
          <el-col :span="24">
            <el-input type="password"
              placeholder="请输入新支付密码" v-model="ruleForm.newPass" auto-complete="off"  ref="input">
            </el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="确认新支付密码"  prop="affirmNewPass">
          <el-col :span="24">
            <el-input type="password"
              placeholder="请确认输入新支付密码" v-model="ruleForm.affirmNewPass"  auto-complete="off" ref="input">
            </el-input>
          </el-col>
        </el-form-item>
        <el-form-item >
      ...
      submitForm(formName) {
       this.$refs[formName].validate((valid) => {
        if (valid) {
            ...
            axios({
              url:'/api/user/update/payPassword/second',
              method: 'get',
              params:{
